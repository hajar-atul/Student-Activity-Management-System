...
<html>
<head>
  <title>Club Login - Student Activities Management System</title>
  <style>
    * {
      margin: 0;
      padding: 0;
...
<div class="login-container">
  ...
  <form action="<%= request.getContextPath() %>/LoginServlet" method="post">
        ...
        <div class="roles">
          ...
          <input type="radio" id="club" name="role" value="club" checked required onclick="location.href='indexClub.jsp'">
