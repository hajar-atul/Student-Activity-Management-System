...
<html>
<head>
  <title>Staff Login - Student Activities Management System</title>
  <style>
    * {
      margin: 0;
      padding: 0;
    ...
    <div class="login-container">
      <form action="<%= request.getContextPath() %>/LoginServlet" method="post">
        ...
        <div class="roles">
          ...
          <input type="radio" id="staff" name="role" value="staff" checked required onclick="location.href='indexStaff.jsp'">
